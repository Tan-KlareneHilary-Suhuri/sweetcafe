 ...
 <div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <img src="image/cupcakes.jpg" class="card-img-top" style="height: 100%" alt="...">
      <div class="card-body">
        <h5 class="card-title">Cupcakes Vanilla</h5>
        <p class="card-text">It is a small cake design, it has frosting and cakes decorations such as fruit and candies.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="image/croissant.jpg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Croissant</h5>
        <p class="card-text">It is buttery, flakey, pastry of Austrian origin. Layered with yeast-leavened dough.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="image/swiss roll.jpeg" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Chocolate Swiss Roll</h5>
        <p class="card-text">It is a sponge cake filled with whipped cream.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="image/cAmericano.jpeg" class="card-img-top"  style="height: 100%" alt="...">
      <div class="card-body">
        <h5 class="card-title">Coffee Americano</h5>
        <p class="card-text">Prepared by diluting an espresso from a flavor of traditional brewed coffee.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="image/espresso.jpeg" class="card-img-top" style="height: 100%" alt="...">
      <div class="card-body">
        <h5 class="card-title">Espresso</h5>
        <p class="card-text">It is a coffee brewing method of Italian origin made with variety of coffee beans and roased degrees.</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="image/latte.jpg" class="card-img-top" style="height: 100%" alt="...">
      <div class="card-body">
        <h5 class="card-title">Latte</h5>
        <p class="card-text">Drink made with espresso and steamed milk.</p>
      </div>
    </div>
  </div>
</div>
		...
		<div class="container justify-content-center">
                <div class="row">
                    ...
                    <a href="completepro.php"class="btn btn-primary btn-xl btn-block">
                        View all products
